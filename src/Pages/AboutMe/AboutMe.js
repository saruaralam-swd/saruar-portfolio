    ...
    <div className="my-10 px-5">
      ...
      <div className="grid md:grid-cols-12 gap-10 px-10">
        ...
        <div className="col-span-12 lg:col-span-9 mt-0 mb-4 md:mt-10 md:mb-0  space-y-4">
          ...
          <p>
            A passionate Front End Web Developer who has the ability to work
            both independently and collaboratively in a fast-paced,
            multi-tasking environment, as well as a strong desire to learn new
            technologies. Make every effort to write code that is clean,
            concise, and efficient. Code that reflects a good user experience
            and makes lives better. I am looking forward to implementing my
            current skills and knowledge in a friendly environment with a team
            of great software engineers and further enriching my knowledge in
            the field of software engineering.
          </p>
          <p>
            Over the last two years, I have gained hands-on experience building
